  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: 'var(--font-body)' }}>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(145deg, #0f2a5e 0%, #1d4ed8 60%, #3b82f6 100%)' }}
      >
        {/* Decorative circles */}
        <div
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-200 text-base leading-relaxed max-w-xs">
            Connect with top companies, track your applications, and land your dream placement — all in one place.
          </p>
        ...
        <div className="relative z-10 border-t border-white/20 pt-6">
          <p className="text-blue-200 text-sm italic">
            "Got placed at Microsoft through CampusConnect — the process was seamless."
          </p>
          <p className="text-white/70 text-xs mt-2">— Priya Sharma, CSE Batch 2024</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-white p-8">
        <div className="w-full max-w-sm">
          ...
          <div className="flex lg:hidden items-center gap-2 mb-8">
            ...
            <span className="text-slate-900 text-lg font-bold" style={{ fontFamily: 'var(--font-display)' }}>
              CampusConnect
            </span>
          </div>
          ...
          <p className="text-slate-500 text-sm mb-8">Sign in to your student account</p>
          ...
          >
            <div className="mb-4">
              <label className="block text-sm font-medium text-slate-700 mb-1.5">Student ID / Email</label>
              <input
                type="text"
          ...
          <p className="text-center text-xs text-slate-400 mt-8">
            ...
            <span className="text-blue-600 cursor-pointer hover:underline">placement@college.edu</span>
          </p>

          {/* Institution badge */}
          <div className="mt-10 pt-6 border-t border-slate-100 text-center">
            <p className="text-xs text-slate-400">Powered by</p>
            <p className="text-sm font-semibold text-slate-600 mt-0.5" style={{ fontFamily: 'var(--font-display)' }}>
