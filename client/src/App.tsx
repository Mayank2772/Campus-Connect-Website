...
export type Page = 'dashboard' | 'profile' | 'drives' | 'applications' | 'schedule' | 'notifications'
...
export default function App() {
  ...
  const hasApplied = (driveId: number) => applications.some((a) => a.driveId === driveId)
  ...
  if (activePage === 'profile') {
    return <ProfilePage onNav={handleNav} activePage={activePage} />
  }
    ...
    if (driveView.screen === 'apply') {
      return (
        <ApplyPage
          ...
          onBack={() => setDriveView({ screen: 'detail', driveId: driveView.driveId })}
          onNav={handleNav}
          activePage={activePage}
